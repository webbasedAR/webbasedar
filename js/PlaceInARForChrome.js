...
import { DropShadowNode } from "./render/nodes/drop-shadow.js";
import { vec3 } from "./render/math/gl-matrix.js";
...
/****** Model GLTF ******/
let flower = new Gltf2Node({ url: "models/GLTF/chair copy/scene.gltf" });
...
vec3.set(shadow.scale, .001, .001, .001);
...
function initXR() {
  ...
  document.querySelector(".chrome_ar").appendChild(xrButton.domElement);
